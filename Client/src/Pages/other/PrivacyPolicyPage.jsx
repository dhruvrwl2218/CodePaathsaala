...
const PrivacyPolicyPage = () => {
  return (
    <div className="bg- text-[#b7babf] min-h-screen p-16">
      <div className="max-w-7xl mx-auto space-y-8">
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold text-indigo-400">1. Introduction</h2>
          <p className="mt-4 text-lg">
            At CodePathsaala, we are committed to protecting your privacy. This
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold text-indigo-400">2. Information We Collect</h2>
          <p className="mt-4 text-lg">
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold text-indigo-400">7. Children's Privacy</h2>
          <p className="mt-4 text-lg">
        ...
        <section className="text-justify">
          <h2 className="text-3xl font-semibold text-indigo-400">9. Contact Us</h2>
          <p className="mt-4 text-lg">

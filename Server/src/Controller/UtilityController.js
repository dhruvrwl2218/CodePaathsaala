...
export const AdminStats = async(req,res) =>{
    ...
    try {
        ...
        res.status(200).json(new ApiResponse(200,{data},"Appications stats are fetched ..."))
    } catch (error) {
        console.log(error)
        res.status(500).json(new ApiResponse(500,"error occured while fetching admin stats"))
    }
